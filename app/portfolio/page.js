          ...
          <div className="grid-3">
            <Link href="/hrms.detail" className="card portfolio-card glass fade-up" style={{ padding: 0, overflow: 'hidden', cursor: 'pointer' }}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/screenshots/landing_page.png')",
            ...
            <Link href="/spicegarden.detail" className="card portfolio-card glass fade-up" style={{ padding: 0, overflow: 'hidden', cursor: 'pointer' }}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/screenshots/spicegarden/home.png')",
                  backgroundSize: 'cover',
                  height: '320px',
                  display: 'flex',
                  alignItems: 'flex-end',
            ...
            <Link href="/doctor.detail" className="card portfolio-card glass fade-up" style={{ padding: 0, overflow: 'hidden', cursor: 'pointer' }}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/screenshots/Doctor%20protfolio/home.png')",
                  backgroundSize: 'cover',
                  height: '320px',
                  display: 'flex',
                  alignItems: 'flex-end',
